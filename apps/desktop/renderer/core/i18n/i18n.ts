  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        projectSearchEmpty: "No projects match your search."
      },
      profile: {
        close: "Close profile",
        language: "Language",
      ...
      explorer: {
        ...
        searchEmpty: "No files or folders match your search.",
  ...
  ko: {
    translation: {
      ...
      dashboard: {
        ...
        projectSearchEmpty: "검색 조건에 맞는 프로젝트가 없습니다."
      },
      profile: {
        close: "프로필 닫기",
        language: "언어",
      ...
      explorer: {
        ...
        searchEmpty: "검색 조건에 맞는 파일이나 폴더가 없습니다.",
      ...
      runs: {
        ...
        wrap: "줄바꿈",
        copy: "복사",
        streamOverview: "스트림 요약",
        lines: "줄 수",
        characters: "문자 수",
        errorCount: "에러 {{count}}개",
        exitCode: "종료 코드",
